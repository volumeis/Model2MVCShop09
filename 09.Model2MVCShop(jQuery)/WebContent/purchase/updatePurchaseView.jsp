	...
	<tr>
		...
		<td class="ct_write01">
			<select name="paymentOption" class="ct_input_g" style="width: 100px; height: 19px"	maxLength="20">
					...
					<option value="1" selected = ${ ! empty purchase.paymentOption && purchase.paymentOption == "1" ? "selected" : "" }>현금구매</option>
					<option value="2" selected = ${ ! empty purchase.paymentOption && purchase.paymentOption == "2" ? "selected" : "" }>신용구매</option>
			</select>
		</td>
	</tr>
 ...
 --%>
	...
	<tr>
		...
		<td width="200" class="ct_write01">
			<input type="text" readonly="readonly" name="dlvyDate" value = "${purchase.dlvyDate}" class="ct_input_g" 

...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			${ ! empty purchase.paymentOption && purchase.paymentOption =="1" ? "현금구매" : ""} 
			${ ! empty purchase.paymentOption && purchase.paymentOption =="2" ? "신용구매" : ""} 
...
<%-- 						<a href="/purchase/updatePurchase?tranNo=${purchase.tranNo}">수정</a> --%>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
						<a href="/purchase/getPurchase?tranNo=${purchase.tranNo}">확인</a>
					</td>
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif"width="14" height="23"/>
					</td>

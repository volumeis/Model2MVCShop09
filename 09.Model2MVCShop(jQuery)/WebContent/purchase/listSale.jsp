...
<%-- 				<% System.out.println("천재형" + request.getAttribute("list")); %> --%>
	<c:set var ="i" value="0"/>
	<c:forEach var ="purchase" items="${list}">
		...
		<tr class="ct_list_pop">
			...
			<td></td>
				<td align="left"><a href="/product/getProduct?prodNo=${purchase.purchaseProd.prodNo}&menu=manage">${purchase.purchaseProd.prodName}</a></td>
			<td></td>
			...
			<td align="left">
				<c:choose >
					...
					<c:when test="${ ! empty purchase.tranCode && purchase.tranCode == '3' }">
					배송완료
					</c:when> 		
				</c:choose>	
			</td>
